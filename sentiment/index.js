...
const natural = require('natural'); // ✅ filled

// Task 2: initialize the express server
const app = express(); // ✅ filled
...
app.post('/sentiment', async (req, res) => { // ✅ filled

    // Task 4: extract the sentence parameter
    const { sentence } = req.query; // ✅ using query parameter as per your template
